...
import restart_schemes.re_radial_search_pd_tweaks
...
pd_algo = @(delta, eps, xy_init,F) fom_pd_QCBP_tweaks(...
...
for i=1:length(alpha)
    [~, ~, ~, VALS] = re_radial_search_pd_tweaks(...
...
for i=1:3
    if i == 1
        [xfin, re_ev_cell, re_ii_cell, VALS] = re_radial_search_pd_tweaks(...
    ...
    elseif i == 2
        [~, re_ev_cell, re_ii_cell, VALS] = re_radial_search_pd_tweaks(...
